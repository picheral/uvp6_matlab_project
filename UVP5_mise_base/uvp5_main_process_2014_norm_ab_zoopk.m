...
function base = uvp5_main_process_2014_norm_ab_zoopk(base,fichier,zoo_norm,processnor,volume_zoo,matvert,min_zoo_esd,config_dir,zoo_list_dir)
        ...
        if strcmp(processnor,'y');
            ...
            if (exist(norm_file)==2);
                ...
                if normalisation == 1
                    ...
                    data_ctd_ab = [];
                    if isfield(base(fichier),'ctdrosettedata_normalized')
