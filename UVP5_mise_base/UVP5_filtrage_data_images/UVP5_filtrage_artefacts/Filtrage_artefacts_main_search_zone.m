...
% the Results folder
% the code uses the files from the results folder
...
fprintf('=========================================================== \n');
fprintf('Define the shape_xx and shape_yy vectors to adapt the zone to remove from the observations in the fig files (map_filter folder) \n');
fprintf('Set ')
