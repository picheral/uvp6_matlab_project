function validation = DataValidation(listecor, results_dir, profilename)
...
%
fig = figure('numbertitle','off','name','Validation figure','Position',[10 200 800 500]);
...
% Formattage du graph
xlabel(['TOTAL number of particles from ',num2str(numel(listecor(:,1))),' images'],'fontsize',8);
ylabel('Pressure','fontsize',8);
...
% Formattage du graph
xlabel(['TOTAL number of particles from ',num2str(numel(aa)),' images (Descent ONLY)'],'fontsize',8);
ylabel('Pressure','fontsize',8);
