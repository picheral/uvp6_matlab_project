function [taxo_ab, taxo_size, taxo_grey] = Uvp6ReadTaxoFromFloatTaxo(taxo_table)
...
%       taxo_size = [depth,time,image_nb,size....];(N cat_number)
...
taxo_size = [taxo_array(:,1) time taxo_array(:,2) taxo_array(:,4:3:end)];
