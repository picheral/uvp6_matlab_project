...
enregistrement = input('enregistrement des résultats? oui/non: ');
% sn002 from sn203
...
[incert_relatives_203_bis, incert_relatives_201] = calculs_incert_relatives(ref_cast, adj_cast, u_esd_ref, u_esd_adj, u_area_mm2_calib_ref, u_area_mm2_calib_adj,ecart_type_ab_ref, ecart_type_ab_adj);
%%
...
if strcmp(enregistrement,'oui')
   % ! ------------------ attention chemin en dur --------------------- !
    save('Z:\UVP_incertitudes\3_etude_incertitudes_relatives_produits_scientifiques\donnees_matlab\incertitudes_relatives.mat','incert_relatives_203','incert_relatives_002','incert_relatives_203_bis','incert_relatives_201','incert_relatives_002_bis','incert_relatives_000008lp')
end