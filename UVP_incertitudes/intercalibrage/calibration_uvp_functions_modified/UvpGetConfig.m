% Catalano 2020/04
% Jacob 2022/06
% copie de CalibrationUvpGetOpenBase pour renommage (en 'UvpOpenBase') pour
% modification afin de propager incertitude(ajout de fullfile)
...
if contains(uvp_cast.project_folder,'uvp5')
    ...
    filename=[uvp_cast.project_folder,fullfile('/','config','uvp5_settings','uvp5_configuration_data.txt')];
