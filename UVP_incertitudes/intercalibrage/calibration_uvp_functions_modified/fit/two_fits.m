% Jacob 2022/06
% copie de create_two_fits pour renommage (en 'two_fits') pour modification
% afin de propager incertitudes (en fait, plot mis en commentaire)

function [fitresult1, gof1] = two_fits(x1,y1,fit_type1,plot_figure,x2,y2,fit_type2)
