...
ref_vol_ech=img_vol_data_ref*ref_nb_img;
...
ref_esd_calib = 2*((aa_data_ref*(pixsize_ref.^expo_data_ref)./pi).^0.5);
ref_esd_calib_all = 2*((aa_data_ref*([1:500].^expo_data_ref)./pi).^0.5);
ref_esd_calib_log = log(ref_esd_calib);
ref_area_mm2_calib = aa_data_ref*(pixsize_ref.^expo_data_ref);
...
adj_vol_ech=img_vol_data_adj*adj_nb_img;
